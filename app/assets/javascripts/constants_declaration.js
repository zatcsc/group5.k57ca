...
var VEHICLE_TYPES= ['car','bus','bike','walk'];
var TRAVEL_MODES = ['DRIVING','TRANSIT','BICYCLING','WALKING'];
var FEATURES = ['find-route','traffic-information','weather','traffic-statistic'];
